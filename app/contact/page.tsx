          ...
          <div className="space-y-6">
              ...
              <Card hover={false} className="p-6">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="flex items-center gap-3 text-cloud-dancer/80 hover:text-warm-sand transition-colors"
                  >
            ...
            <FadeIn direction="up" duration={0.6} delay={0.3}>
              <Card hover={false} className="p-6">
                ...
                {regionInfo.contact.companyName && (
                  <p className="text-cloud-dancer font-medium mb-3">
                    {regionInfo.contact.companyName}
                  </p>
                )}
                <div className="flex items-start gap-3 text-cloud-dancer/80">
            ...
            <FadeIn direction="up" duration={0.6} delay={0.4}>
              <Card hover={false} className="p-6 bg-warm-sand/10 border-warm-sand/30">
                ...
                <p className="text-cloud-dancer/80 text-sm">
            ...
            <FadeIn direction="up" duration={0.6} delay={0.5}>
              <Card hover={false} className="p-6">
                ...
                <ol className="space-y-3 text-cloud-dancer/80 text-sm">
