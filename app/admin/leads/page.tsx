...
import { X, MessageSquare, Filter, Trash2 } from 'lucide-react';
      ...
      <div className="p-8">
        ...
        {selectedLead && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[100] p-4">
            <Card hover={false} className="w-full max-w-2xl max-h-[90vh] overflow-y-auto scrollbar-hide">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-sm text-red-500 hover:bg-red-100 dark:hover:bg-red-500/20 rounded transition-colors"
                >
                  <Trash2 size={14} />
                  Delete Lead
                </button>
